    ...
    return (
        <div className="bg-[#1e293b] border border-[#334155] rounded-2xl shadow-2xl w-full max-w-md lg:mx-4 overflow-hidden">
            ...
            <div className="bg-blue-700 px-8 pt-6 pb-4">
                ...
                <h2 className="text-slate-100 text-lg font-semibold text-center">Mess Information</h2>
                <p className="text-blue-200 text-xs text-center mt-0.5">Tell us about your mess</p>
            </div>
            ...
            <div className="px-8 py-6 space-y-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        <FileText className="absolute left-3 top-3 w-4 h-4 text-blue-400" />
                        <textarea
                            ...
                            onChange={handleChange}
                            rows={3}
                            className="w-full pl-9 pr-4 py-2.5 rounded-lg border border-[#334155] bg-[#0f172a] text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:border-blue-500 transition resize-none"
                        />
                    </div>
                </div>

                {/* Info box */}
                <div className="bg-blue-900/50 border border-blue-800 rounded-xl p-3 flex gap-2">
                    <Building2 className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" />
                    <p className="text-xs text-slate-400 leading-relaxed">
                        You will become the <strong className="text-slate-100">admin</strong> of this mess. You can invite members after setup.
                    </p>
                </div>
